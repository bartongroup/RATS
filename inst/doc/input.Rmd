...
2. `abund_thresh` - Noise threshold. Transcripts with abundance below that value in both conditions are ignored. Higher threshold values are stricter. (Default 10)
...
Higher threshold values are stricter. (Default 0.10)
...
3. `conservative` - Whether the replicate-wise reproducibility should be used as a criterion in calling DTU. (Default FALSE)
