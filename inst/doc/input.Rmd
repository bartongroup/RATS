...
* Any transcript IDs present in the data but missing from the annotation will be silently ignored and 
will not show up in the output, as they cannot be matched to the gene IDs.
* Any transcript/gene ID present in the annotation but missing from the data will be included in the output as zero expression.
* If the samples appear to have been quantified with different annotations from one another, RATs will abort.
