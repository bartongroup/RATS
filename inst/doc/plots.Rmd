...
the measurements are very similar. 
...
This structure is great for seeing changes in the isoform distribution profile of a gene. A minimalist version of the plot can also be obtained:
...
![Transcript significance VS effect size](./fig/tvolcano.jpg)
![Gene significance VS largest effect size among isoforms](./fig/gvolcano.jpg)
...
![Effect size distribution](./fig/dprop.jpg)
![Largest isoform effect size per gene](./fig/maxdprop.jpg)
...
![Reproducibility VS effect size](./fig/reprodvsdprop.jpg)
![Distribution of reproducibility](./fig/reprod.jpg)
...
![Fold change VS significance](./fig/fcvolcano.jpg)
![Fold change VS proportion change](./fig/fcvsdprop.jpg)
