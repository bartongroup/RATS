...
mydtu <- call_DTU(sim$slo, sim$annot, "foo", "bar", boots = "prop-test", verbose = FALSE)

# Only bootstrap gene calls.
mydtu <- call_DTU(sim$slo, sim$annot, "foo", "bar", boots = "G-test", verbose = FALSE)
```
...
```{r}
# Transcripts only.
mydtu <- call_DTU(sim$slo, sim$annot, "foo", "bar", testmode="prop-test", verbose = FALSE)
# Genes only.
mydtu <- call_DTU(sim$slo, sim$annot, "foo", "bar", testmode="G-test", verbose = FALSE)
```
