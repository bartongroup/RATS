...
The most current version (in progress) of `rats` can be installed directly from the working copy on Github, using the [devtools](https://www.rstudio.com/products/rpackages/devtools/) package:
...
The samples are coloured differently, to allow finding the related points across isoforms.
The boxplot line colour encodes the transcript-level DTU calls, to highlight the relevant isoforms.
