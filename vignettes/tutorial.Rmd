...
10. `data_type` - The format of the input data.
11. `num_genes` - The number of genes in the provided annotation.
12. `num_transc` - The number of transcripts in the provided annotation.
13. `description` - Free-text description of the run. It is useful to record data sources, annotation source and version, experimental parameters...
14. `rats_version` - The version of the package.
15. `R_version` - A list with the details of the R version.
