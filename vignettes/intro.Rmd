...
**RATs is workflow-agnostic**. The concern over quantification accuracy is left to the quantification tool and RATs uses only the
...
are rather arbitrary and probably quite permissive. This means you are likely to get an inflated number of positive calls.

For explanations of the available thresholds and other settings, refer to the Input & Parameters vignette.
