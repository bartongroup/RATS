...
This structure is great for seeing changes in the isoform distribution profile of a gene. A more minimalist version of the plot, without the boxpltos,
...
If you prefer picking points from a plot rather than sorting through tables, the volcano plot is also available through 
